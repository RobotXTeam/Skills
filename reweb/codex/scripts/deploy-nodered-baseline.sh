...
NODE_CSS=/usr/lib/node_modules/node-red/custom.css
# The old post-install injector call was removed together with the
# de-injection redesign: this restore now returns Node-RED to its
# byte-for-byte factory state (stock :1880, editor at /).
