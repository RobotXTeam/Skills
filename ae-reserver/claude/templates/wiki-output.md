...
```bash
scp build/[demo_name] recamera@192.168.42.112:/home/recamera/[demo_name]/
scp *.cvimodel recamera@192.168.42.112:/home/recamera/[demo_name]/models/
```

:::note
`192.168.42.112` 是 reCamera 通过 USB 连接时的默认地址；如果设备通过其它方式联网或 IP 有变化，请替换为设备实际 IP。
:::
...
**绝对禁止**出现本机路径（含 Steven 本机与 seeed-reserver 主机的内部绝对路径）：
- ❌ `/home/steven/...`
- ❌ `/home/seeed0/...`
- ❌ `C:\Users\...`
