...
- seeed C++ demo 仓库（本地仓库 = 编译位置 = 唯一真源）：`/home/seeed/work/sscma-example-sg200x`
- 新 demo 默认目录：`/home/seeed/work/sscma-example-sg200x/solutions/sesg-project/<demo_name>`

不再保留"本机副本/迁移前参考"这种双份概念。编辑、构建、打包、提交全部在 `seeed` 主机的 `/home/seeed/work/sscma-example-sg200x` 内完成；本机不再放第二份 demo 仓库。

## seeed 上的工具链目录

- seeed C++ demo 仓库：`/home/seeed/work/sscma-example-sg200x`
...
在下载或克隆资源前，先检查 `seeed` 上这些已有目录：

- `/home/seeed/work/sscma-example-sg200x`
