#!/usr/bin/env python3
"""UDP datagram relay (seeed side) — fallback when the device is NOT on the same
...
UDP is not possible (device reachable only via seeed USB, or routed path has a
...
Example:
  ...
  # device sender targets seeed's USB IP:9100 (e.g. 192.168.42.155:9100)
"""
import socket
import sys
